...
public class Constants {
	public static final String BASE_IP = "http://localhost:9585/";
	public static final String BASE_DIR = "/home/br/Desktop/prem/spring_project/src/main/resources/templates/Img/";
	public static final String BANNER_LOCATION = "main_banner/";
	...
	public static String saveMultiPartFile(MultipartFile file, String path, String fileNameWithExtension) {
		if (file != null) {
			...
			try {
				///////////
				/*
				 * BufferedOutputStream fileOuputStream = new BufferedOutputStream( new
